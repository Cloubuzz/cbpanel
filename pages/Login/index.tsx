...
export const Login: React.FC<LoginProps> = ({
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-white flex items-center justify-center relative overflow-hidden font-sans selection:bg-teal-500 selection:text-white">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border-2 border-transparent focus:border-teal-500 rounded-2xl px-5 py-4 text-sm transition-all outline-none text-white placeholder:text-slate-600"
                />
              </div>
      ...
      {/* Styles for custom animations and input overrides not in standard tailwind */}
      <style>{`
