...
export const SalesByCityChart: React.FC<Props> = ({ data, isLoading }) => (
  <>
    <h2 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4">Sales By City</h2>
