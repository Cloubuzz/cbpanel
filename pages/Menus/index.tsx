...
const BRANCHES: { id: string; name: string; location: string }[] = [];
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="space-y-4">
            {filteredMenus.length === 0 && (
              <div className="flex flex-col items-center justify-center text-center gap-2 text-slate-400 py-12">
                <MenuIcon size={32} className="opacity-50" />
                <p className="text-sm font-medium">
                  {menus.length === 0 ? 'No menus yet.' : 'No menus found matching your search.'}
                </p>
              </div>
            )}
              ...
              >
                ...
                <div className="p-8 bg-slate-50 dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      onClick={handleSave}
                      className="flex items-center gap-2 px-8 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-bold shadow-xl transition-all hover:scale-105 active:scale-95"
                    >
                      <Save size={20} />
                      Save Menu
                    </button>
