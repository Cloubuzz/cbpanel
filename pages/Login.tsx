      ...
      <div className="relative z-10 w-full max-w-md p-6 perspective-1000">
          ...
          <div className="bg-[#0f172a]/80 backdrop-blur-2xl rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center mb-8 relative">
               <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-slate-800 to-slate-900 border border-slate-700 flex items-center justify-center shadow-2xl mb-4 group-hover:border-teal-500/30 transition-colors duration-500">
                  ...
                  <Zap size={36} className="text-teal-400 relative z-10 drop-shadow-[0_0_10px_rgba(45,212,191,0.5)]" fill="currentColor" />
               </div>
               <h1 className="text-3xl font-bold text-white tracking-tight mb-1">Cloubuzz</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1">
                 <label className="text-xs font-semibold text-slate-400 ml-1 uppercase tracking-wider">Identity</label>
              ...
              <div className="space-y-1">
                 <label className="text-xs font-semibold text-slate-400 ml-1 uppercase tracking-wider">Credential</label>
                 <div className={`relative bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 flex items-center transition-all duration-300 ${focusedField === 'password' ? 'border-teal-500 shadow-[0_0_15px_rgba(45,212,191,0.1)]' : 'hover:border-slate-600'}`}>
                    <Lock size={18} className={`mr-3 transition-colors ${focusedField === 'password' ? 'text-teal-400' : 'text-slate-500'}`} />
                    <input 
                      type="password" 
                      value={password}
                      onChange={(e) => {
            ...
            <div className="mt-8 pt-6 border-t border-slate-800/50 flex flex-col items-center gap-4">
               <p className="text-[10px] text-slate-500 uppercase tracking-widest">Biometric Login</p>
        ...
        <div className="mt-8 text-center space-y-2">
            <div className="flex items-center justify-center gap-2 text-[10px] text-slate-600 font-mono">
               ...
               <span className="flex items-center gap-1 text-emerald-500"><div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div> OPERATIONAL</span>
            </div>
        </div>
