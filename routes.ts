...
export const getViewFromPath = (pathname: string): View => {
  ...
  if (normalized === '/admin/automations' || normalized.startsWith('/admin/automations/')) return 'automations';
  ...
  if (normalized === '/admin/outlets' || normalized.startsWith('/admin/outlets/')) return 'outlets';
  if (normalized === '/admin/reports' || normalized.startsWith('/admin/reports/')) return 'reports';
